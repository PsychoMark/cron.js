(function (factory)
{
    ...
    {
        // CommonJS or Node
        factory(require("moment-timezone"), exports);
    }
    else if (typeof define === "function" && define["amd"])
    {
        // AMD anonymous module with hard-coded dependency
        define(["moment-timezone", "exports"], factory);
    }
    else
    {
        // <script> tag: use the global
        factory(moment);
    }
}
